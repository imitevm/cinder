...
class VMwareVcVmdkDriver(driver.VolumeDriver):
    ...
    def _is_datastore_accessible(self, ds_summary, ds_host_mounts, available_hosts):
        # available_hosts empty => vmware_cluster_name not specified => don't filter by hosts
        ...
        return ds_summary.accessible and not self.volumeops._in_maintenance(ds_summary) and cluster_access_to_ds
    ...
    def _get_volume_stats(self):
        ...
        prop_spec = vim_util.build_property_spec(client_factory, 'Datastore', ['summary', 'host'])
        ...
        while True:
            for ds in result.objects:
                ...
                if self._is_datastore_accessible(summary, ds_props['host'], available_hosts):
